...
?>
<?php $c_val["Admin"]["Organization Structures"]["Holidays"] = 'end1234'; ?>
<!DOCTYPE html>
<!-- 
					...
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								...
								<h4 class="modal-title"><div class="caption"><b>Add New Holiday</b></div></h4>
							</div>
							<div class="modal-body">                
                <?php include ("content/add/add_holiday.php"); ?>
        ...
        <div class="modal fade bs-modal-lg" id="large1" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
								<h4 class="modal-title"><div class="caption"><b>Edit Holiday</b></div></h4>
							</div>
							<div class="modal-body">                
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Holiday List
								</div>
								<div class="tools">
...
BU.init('HOLIDAYS','H','sample_2','1','HOLIDAYS');
function myFunction(oid){
$.ajax({url: "content/edit/edit_holiday.php?holidayID="+oid,cache: false,
			 beforeSend: function(){
				 loading();
			 },
