...
?>
<?php $c_val["Admin"]["Organization Structures"]["Reason Master"] = 'end1234'; ?>
<!DOCTYPE html>
<!-- 
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Reason Master List
								</div>
								<div class="tools">
...
<script src="js/add/add_reason_validation.js"></script>
<script src="js/edit/edit_reason_validation.js"></script>
...
BU.init('REASONMAST','REASON','sample_2','1','Reason');
</script>
</body>
<!-- END BODY -->
</html>
