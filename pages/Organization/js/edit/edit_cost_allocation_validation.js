    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                function (form) {                  
                      var url = "editData.php?pagetype=edit_cost_allocation";
                      var formData = {};
...
function myFunction(OempCode){
  $.ajax({url: "content/edit/edit_cost_allocation.php?pagetype=editCostAllocation&OempCode="+OempCode, success: function(result){
  //alert (OempCode);
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
