    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                function (form) {                  
                      var url = "ajax/editData.php?pagetype=edit_country";
...
function myFunction(countryId){
  $.ajax({url: "content/edit/edit_country.php?pagetype=editCountry&countryId="+countryId, success: function(result){
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
		FormValidation.init();
