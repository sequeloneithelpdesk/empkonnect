    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                function (form) {                  
                      var url = "editData.php?pagetype=edit_level";
...
function myFunction(olevelCode){
$.ajax({url: "content/edit/edit_level.php?pagetype=editLevel&olevelCode="+olevelCode, success: function(result){
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
		FormValidation.init();
