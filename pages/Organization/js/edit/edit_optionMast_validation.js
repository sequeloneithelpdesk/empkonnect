    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                function (form) {                  
                      var url = "editData.php?pagetype=edit_optionMast";
...
function myFunction(ofieldName){
$.ajax({url: "content/edit/edit_optionMast.php?pagetype=editOption&ofieldName="+ofieldName, success: function(result){
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
		FormValidation.init();
