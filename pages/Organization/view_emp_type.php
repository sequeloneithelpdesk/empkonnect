...
?>
<?php $c_val["Admin"]["Organization Structures"]["Employee Type"] = 'end1234'; ?>
<!DOCTYPE html>
<!-- 
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Employee Type List
								</div>
								<div class="tools">
...
BU.init('TypeMast','TYPE','sample_2','1','Employee Type');

function myFunction(oid){
  $.ajax({url: "content/edit/edit_emp_type.php?pagetype=editEmpType&TYPEID="+oid,cache: false,
			 beforeSend: function(){
				 loading();
			 },
