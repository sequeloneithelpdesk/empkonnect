...
?>
<?php $c_val["Admin"]["Organization Structures"]["Business Units"] = 'end1234'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Grade List
								</div>
								<div class="tools">
...
BU.init('GRDMast','GRD','sample_2','1','Grade');

function myFunction(oid){
$.ajax({url: "content/edit/edit_grade.php?pagetype=editGrade&GRDID="+oid, success: function(result){
			console.log(result);
			$('#edit').show();
			$('#edit').html(result);
			$('#large1').modal('show');
