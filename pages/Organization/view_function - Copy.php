<?php @session_start(); ?>
<?php $c_val["Admin"]["Organization Structures"]["Functions"] = 'end1234'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
				...
				<div class="modal-dialog lg">
					<div class="modal-content" style="width:850px;">
						...
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
							<h4 class="modal-title"><div class="caption"><b>Add New Functions</b> </div></h4>
							</div>
							<div class="modal-body">                
	                			<?php include ("content/add/add_function.php"); ?>
	              			</div>
					</div>
						<!-- /.modal-content -->
					</div>
        ...
        <div class="modal fade bs-modal-lg" id="large1" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
								<h4 class="modal-title"><div class="caption"><b>Edit Functions</b></div></h4>
							</div>
							<div class="modal-body">                
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Functions List
								</div>
								<div class="tools">
                      ...
                      <a class="btn default blue" data-toggle="modal" href="#large">
							...
							<thead><tr class='odd gradeX'><th>Function Code</th>
									<th>Function Name</th>
									<th>Function Type</th>
									<th>Function Head</th>
...
<?php 
                ...
                while($row = $fetch($result)) {
	                ...
	                $list.= "<tr class='odd gradeX'>
	                		<td>".$row['FUNCT_CODE']."</td>
	                		<td>".$row['FUNCT_NAME']."</td>
	                		<td>".$row['FUNCT_TYPE']."</td>
	                		<td>".$row['FUNCTHEAD']."</td>
	                		<td style='white-space: nowrap'><a class='btn' data-toggle='modal' href='#large1' onclick=\"myFunction('$id')\">Edit</a></td>
	                		</tr>";
                }
                echo $list;
...
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="js/add/add_function_validation.js"></script>
<script src="js/edit/edit_function_validation.js"></script>
<script>
