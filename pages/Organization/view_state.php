...
$c_val["Admin"]["Organization Structures"]["States"] = 'end1234';
...
<div class="clearfix">
        ...
        <div class="modal fade bs-modal-lg" id="large" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								...
								<h4 class="modal-title"><div class="caption"><b>Add New state</b></div></h4>
							</div>
							<div class="modal-body">                
                <?php include ("content/add/add_state.php"); ?>
				...
				<div class="modal fade bs-modal-lg" id="large1" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
								<h4 class="modal-title"><div class="caption"><b>Edit state</b></div></h4>
							</div>
							<div class="modal-body">                
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View State List
								</div>
								<div class="tools">
            ...
            <thead>
            <tr class='odd gradeX'><th>State Code</th>
            <th>State Name</th>
            <th>Status</th> 
            <th>Action</th></tr>
            </thead>
...
<script src="js/add/add_state_validation.js"></script>
<script src="js/edit/edit_state_validation.js"></script><script src="../js/toastr.js" type="text/javascript"></script><script src="../js/common.js" type="text/javascript"></script> <script src="../js/table-excel.js"></script>  <script src="js/common_bu.js" type="text/javascript"></script> <script src="js/company.js" type="text/javascript"></script>  <script>  jQuery(document).ready(function() {        
...
BU.init('StateMast','State','sample_2','1','State');
function myFunction(oid){
		$.ajax({url: "content/edit/edit_state.php?pagetype=editState&ostateId="+oid, success: function(result){
			console.log(result);
			$('#edit').show();
			$('#edit').html(result);
			$('#large1').modal('show');
