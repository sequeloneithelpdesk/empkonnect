...
?>
<?php $c_val["Admin"]["Organization Structures"]["Process"] = 'end1234'; ?>
<!DOCTYPE html>
<!-- 
...
<!--<![endif] [if IE 9]> <html lang="en" class="ie9 no-js"> <![endif]-->
<!--[if !IE]><!-->
<html lang="en">
<!--<![endif]-->
<!-- BEGIN HEAD -->
...
<div class="page-content-wrapper cus-dark-grey">
	...
	<div class="page-container">
		...
		<div class="page-sidebar-wrapper modified">
			<div class="page-sidebar navbar-collapse collapse cus-dark-grey"><?php include('../include/leftMenu.php'); ?></div>
		</div>
		<!-- END SIDEBAR -->
		<!-- BEGIN CONTENT -->
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Process List
								</div>
								<div class="tools">
...
<script src="../js/toastr.js" type="text/javascript"></script><script src="../js/common.js" type="text/javascript"></script> <script src="../js/table-excel.js"></script>  <script src="js/common_bu.js" type="text/javascript"></script> <script src="js/company.js" type="text/javascript"></script>  <script>  jQuery(document).ready(function() {        
...
BU.init('PROCMAST','PROC','sample_2','1','Process Type');

function myFunction(oid){
		$.ajax({url: "content/edit/edit_process.php?pagetype=editProcess&PROCID="+oid, success: function(result){
			console.log(result);
			$('#edit').show();
			$('#edit').html(result);
			$('#large1').modal('show');
