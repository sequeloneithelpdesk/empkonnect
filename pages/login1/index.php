                        ...
                        <form method="post" class="col s12 p-0 login-form" action="login.php">
                            <div class="row">
                                ...
                                <div class="input-field col s12 p-0">
                                    <input id="company_code" type="text" class="validate" required="true" name="customer">
                                ...
                                <div class="input-field col s12 p-0 login-btn">
                                    ...
                                    <button type="submit" id="sub-att" class="cust-btn mb-10 upc dark-blue-bg col s12 pt-10 pb-10 waves-effect waves-light fs-16 white-txt center-align">Login</button>
...
<script type="text/javascript">
    ...
    $(document).on('keyup', '.input-field', function () {
        ...
        if (company_code.length > 0) {
            $('#comprequire_code').fadeOut(2000);
        }
        else {
            $('#comprequire_code').show();
        }
    ...
    function show_question_div(s)
    {
        ...
        if (id_user == "" || company_code == "")
        {
            ...
            if (company_code == "")
            {
                $("#comprequire_code").html("Required field");
            }
        }
        else {

            var dataString = 'action='+ s+'&uid=' + id_user+'&compcode=' + company_code;
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(data != "false") {
                        ...
                        $("#show_error").html("Incorrect Company Code or Login ID");
                    }
