            ...
            <div class="page-content cus-light-grey">
                ...
                <div class="page-bar z-depth-1">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#">Shutdown Leave Upload</a>
                        </li>
                    </ul>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="portlet box blue z-depth-1">
                            <div class="portlet-title">
                                <div class="caption">
                                    <i class="fa fa-edit"></i>Shutdown Leave Upload
                                </div>
                                ...
                                <form class="form-horizontal">
                                    <div class="form-body">
                                        <div class="form-group">
                                            <div class="col-md-3">
                                                <a href="blank_shutdown.csv" class="btn btn-block green">
                                                    Download blank Template <i class="fa fa-download"></i>
                                                </a>
                                            </div>
                                            <div class="col-md-4">
                                                Download blank template for Shutdown Leave Upload .
                                            </div>
                                        </div>
