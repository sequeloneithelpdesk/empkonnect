...
$sqlqsu="select distinct CONVERT (VARCHAR(10),LvFrom,103 ) as startDate,  CONVERT (VARCHAR(10),LvTo,103 ) as endDate, status,reason,LvType,CreatedBy,Trn_Date from leave 
where CreatedBy='".$emp_code."' and status=1 and YEAR(LvFrom) = YEAR(getDate()) order by Trn_Date asc ";
//echo $sqlqsu;
...
//print_r($resultsu);
$sqlq1su="select distinct CONVERT (VARCHAR(10),LvFrom,103 ) as startDate,  CONVERT (VARCHAR(10),LvTo,103 ) as endDate,LvType, status,reason,CreatedBy,Trn_Date from leave 
where CreatedBy='".$emp_code."' and status=2 and YEAR(LvFrom) = YEAR(getDate()) order by Trn_Date asc";
//echo $sqlq1su;
...
<html lang="en">
	...
	<head>
		...
		<style>
			...
			.red,.red2,.green,.green2,.green_over,.blue_over,.red_over,.yellow,.yellow_over,.pink{
				height: 65px;
			    margin-left: -1px;
			    margin-right: -1px;
			    margin-top: -22px;
										...
										if ($num($resultq)) {
											...
											while ($rowq = $fetch($resultq)) {
												...
												<div class="empSearchResult clearfix">
													...
													<div class="empSearchInfo col-md-10">
																	<span class="fit">
																	 <?php echo $rowq['EMP_NAME'];?><i class="fa fa-gift"></i>
																	</span>
																	<span class="fit">
																		<span class="kEmpCod"><?php echo $rowq['Emp_Code'];?></span>
																	</span>
										...
										if ($num($resultq2)) {
											...
											while ($rowq2 = $fetch($resultq2)) {
												...
												<div class="empSearchResult clearfix">
													...
													<div class="empSearchInfo col-md-10">
																	<span class="fit">
																	 	<?php echo $rowq2['EMP_NAME'];?><i class="fa fa-gift"></i>
																	</span>
																	<span class="fit">
