    ...
    function getLeaveBalance(lvtype,ecode){
       ...
       // alert(applDays);
        ...
        else if(lvtype == 2)
        {
          ...
          {
              // alert("applDays1"+applDays);
            $("#leaveErr").html("Should be less than 2 or equel 2 leave Casual Leave");
           $("#leaveSubmit").prop('disabled', true);
            $("#usenextleave").hide();
            $("#uploadMultiple").hide();
          }
         ...
         //alert(parseInt(applDays)+parseInt(SL.innerHTML));
            $("#leaveErr").html("");
            $("#usenextleave").hide("");
            $("#leaveSubmit").show();
            if(applDays >= SL.innerHTML)
            {
           //  alert("aaa");
               $("#leaveErr").html("Don't have Enough Balance for This Leave");
              $("#uploadMultiple").hide();
