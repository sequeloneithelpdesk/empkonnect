...
$c_val["Leave Management"]["Leave Request-Approval"] = 'end1234';
//$c_val = 'end1234';
?>
<!DOCTYPE html>
...
<div class="page-content-wrapper cus-dark-grey">
    ...
    <div class="page-container">
        ...
        <!-- END SIDEBAR -->
        <!-- BEGIN CONTENT -->
        <?php include ('content/approveLeaveRequest_content.php');?>
...
<script src="js/approveLeaveReq.js"></script>
<script>
...
<script type="text/javascript">
    ...
    $("input[name=action_radio_all]:radio").change(function () {
       var a= $("input[name='action_radio_all']:checked").val();
       if(a==0)
       {
        $('#hide_LeaveReasons_combo1').css({'display':'block'});
       }
       else
       {
        $('#hide_LeaveReasons_combo1').css({'display':'none'});
         $('#hide_LeaveReasons_text1').css({'display':'none'});
       }
   // alert("q"+a);
   
});
function change_LeaveReasons1()
{
   // alert("p");
    var val1=$("#LeaveReasonscombo1 option:selected").text();
    if(val1==='Other')
    {
       alert(val1); 
        $('#hide_LeaveReasons_text1').css({'display':'block'});
       }
       else
       {
        alert("w");
