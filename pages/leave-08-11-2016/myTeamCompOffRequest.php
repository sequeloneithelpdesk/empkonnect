...
while ($row = $fetch($res)){
    $teammember[] = $row['Emp_Code'];
}
$team= implode(',', $teammember);
//print_r($teammember);
$c_val["Leave Management"]["My Team Comp off Request"] = 'end1234';
?>
<!DOCTYPE html>
...
<div class="page-content-wrapper cus-dark-grey">
    ...
    <div class="page-container">
        ...
        <!-- END SIDEBAR -->
        <!-- BEGIN CONTENT -->
        <?php include ('content/myTeamCompOffRequest_content.php');?>
...
<script>
    ...
    function submitCancelRequest(coId,code){
        ...
        $.ajax({
            ...
            data: {id: coId, type:type, code:code},
            success: function (result) {
                if(result == 1){
                    location.reload();
                }else{
