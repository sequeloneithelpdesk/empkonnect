                                            ...
                                            <div class="form-group" style="display:none">
                                                ...
                                                <input type="hidden" name="leaveFor" id="leaveFor" value="<?php echo $code;?>">
                                                    <div class="icheck-inline">
                                                        ...
                                                        <?php 
                                                            $sql="select count(Emp_Code) as number from EmpNameQry where MNGR_CODE='$code'";
                                            ...
                                            <div class="form-group" id="empdetail" style="display: none;">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    <option value="">select </option>
                                                        <?php $sql="select Emp_Code,EMP_NAME from Hrdmastqry where MNGR_CODE='$code'";
...
">Past  </a></sapn></p>
                                        ...
                                        <div class="form-group" style="margin-top: 10px;"> 
                                                ...
                                                <div class="col-md-3 collapse" id="Notification">  
                                                    ...
                                                    <select name="notificationto" id="notificationto" width="100%" class="form-control bs-select" data-placeholder="Select..." multiple>
                                                                      <option value=""></option>>
                                                                        <?php $quer="select EMP_NAME, Emp_Code from EmpNameQry"; 
