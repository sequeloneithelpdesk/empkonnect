                                    ...
                                    <form action="#" class="form-horizontal" id="outWorkForm">
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div id="timemanagement1" class="col-md-6" style="top: 35px; display: none;">
                                                ...
                                                <div id="timemanagement2" class="col-md-6" style="top: 35px; display: none;">
                                            ...
                                            <div class="form-group">
                                               <div class="col-md-9">
                                                    ...
                                                    <?php echo $data['MNGR_NAME'];?>, <?php echo $data1['DSG_NAME'];?>, <?php echo $data1['MailingAddress'];?>
                                                </div>
                                            </div>
