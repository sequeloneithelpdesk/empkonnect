...
if($_POST['type']=="statusVise")
{
    ...
    if ($empCode=="all"){
        $sql="select *,convert(varchar(10),DOB,103) as DOB,convert(varchar(10),DOJ,103) as DOJ from HrdMastQry where Status_Code='$statusCode' ";
    }else {
        $sql= "select *,convert(varchar(10),DOB,103) as DOB,convert(varchar(10),DOJ,103) as DOJ from HrdMastQry where Status_Code='$statusCode' AND Emp_Code='$empCode'";
    }
    ...
    echo  " 
                        ...
                        echo "  <tr>
                                    ...
                                    if($row['Emp_Title'] == 1){
                                        echo "Mr. ";
                                    }elseif ($row['Emp_Title'] == 2) {
                                        echo "Mrs. ";

                                    }elseif ($row['Emp_Title'] == 3) {
                                       echo "Mss. ";
                                    }
                                    echo $row['EMP_NAME'];
                                 echo   "</td>
