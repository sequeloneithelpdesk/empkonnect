...
$c_val["Profile"]["View Employee"] = 'end1234';
...
<div class="page-content-wrapper cus-dark-grey">
	...
	<div class="page-container">
        ...
        <div class="modal fade bs-modal-lg" id="large11" tabindex="-1" role="dialog" aria-hidden="true">
                ...
                $sql= "select Emp_Code,EMP_NAME,DSG_NAME,convert(varchar(10),DOJ,103) as DOJ,MNGR_CODE,MNGR_CODE2,MNGR_NAME,LOC_NAME,FUNCATONAL_MNGR_NAME from HrdMastqry ";
				if($type=="A"){
                ...
                if ($row_count) {
					...
					while($row =$fetch($result)) {
						...
						$list.= "<tr class='odd gradeX'><td>".$i."</td><td>" . $row['Emp_Code']. "</td><td>" . $row['EMP_NAME']. "</td><td>" . $row['DOJ']. "</td><td>" .$row['DSG_NAME']. "</td><td>" .$row['MNGR_NAME']. "</td><td>" . $row['FUNCATONAL_MNGR_NAME']. "</td><td>" . $row['LOC_NAME']. "</td><td style='white-space: nowrap'><a class='btn' href='editEmployee.php?oempCode=$oempCode'>View</a></td></tr>";
						$i++;
					}
					echo $list;
                } else {
