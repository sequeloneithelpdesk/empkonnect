...
?>
<form action="#" id="AddFamilyForm" class="form-horizontal">
    <div class="form-body">
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <Select class="form-control" name="relationship" id="relationship">
                        ...
                        <?php
                        $sql="select * from lovmast where lov_value not in (select Relation from hrdfamily where EMP_CODE='$empCode' and Relation='1' or Relation='2' group by Relation) and  LOV_Field='nominee'";
    ...
    <div class="form-actions">
        <div class="row">
            <div class="col-md-offset-8 col-md-5">
                <button type="button" onclick="submitAddFamily('<?php echo $empCode; ?>')" class="btn blue">OK</button>
