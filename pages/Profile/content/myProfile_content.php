            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header portlet box blue">
                        ...
                        <h4 class="modal-title white-txt" >Add Relative Details</h4>
                    </div>
        ...
        <div class="modal fade" id="portlet-configEdit" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header portlet box blue">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title white-txt" >Edit Relative Details</h4>
                    </div>
        ...
        <div class="modal fade" id="portlet-config2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header portlet box blue">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title white-txt" >Add Qualification Details</h4>
                    </div>
        ...
        <div class="modal fade" id="portlet-configEdit2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header portlet box blue">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title white-txt" >Edit Qualification Details</h4>
                    </div>
        ...
        <div class="modal fade" id="portlet-config3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header portlet box blue">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title white-txt" >Add Language Details</h4>
                    </div>
        ...
        <div class="modal fade" id="portlet-configEdit3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header portlet box blue">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title white-txt" >Edit Language Details</h4>
                    </div>
        ...
        <div class="modal fade" id="portlet-config1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header portlet box blue">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title white-txt" >Add Nominee Details</h4>
        ...
        <div class="modal fade" id="portlet-configEdit1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header portlet box blue">
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                        <h4 class="modal-title white-txt">Edit Nominee Details</h4>
                ...
                <div class="profile-sidebar" style="width:250px;">
                    ...
                    <div class="portlet light profile-sidebar-portlet" >
                        ...
                        <div class="profile-userbuttons">
                            <!--<button type="button" class="btn btn-circle green-haze btn-sm">Remove</button>-->
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            <form role="form" id="editPersForm" action="#">
                                                ...
                                                <div class="form-group" id="FMname" style="display:none;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" placeholder="First Name" name="empFName" id="fname" maxlength="50" value="<?php echo $row['Emp_FName'];?>" class="form-control" readonly/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">Middle Name</label>
                                                            <input type="text" placeholder="Middle Name" id="mname" name="empMName" maxlength="50" value="<?php echo $row['Emp_MName'];?>" class="form-control" readonly/>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6" id="Lname" style="display: none;">
                                                            ...
                                                            <input type="text" class="form-control" value="<?php echo $row['Emp_LName'];?>" maxlength="50" name="empLName" id="lname" readonly>
                                                        </div>
                                                        <div class="col-md-6" id="fullName" style="display: block;">
                                                            <label class="control-label">Full Name</label>
                                                            <input type="text" class="form-control" value="<?php $fullname = $row['Emp_FName'] ." ". $row['Emp_MName'] ." ". $row['Emp_LName']; 
                                                    if($row['Emp_Title']=='1'){ echo "Mr. "; }elseif ($row['Emp_Title']=='2') { echo "Mrs. "; }elseif($row['Emp_Title']=='3'){ echo "Mss. ";} echo  ucwords(strtolower($fullname));?>" " name="fLName"  readonly>
                                                        </div>
                                                        <div class="col-md-6">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input name="gaurdian" id="gaurdian" type="text" maxlength="100" value="<?php echo $row['GuardianName'];?>" class="form-control" readonly/>
                                                </div>
                                                <?php }else{?>
                                                        <div class="col-md-6">
                                                ...
                                                <div class="col-md-offset-9 margiv-top-10">
                                                    <a href="#" onclick="perEnableTexts();" id="editButton" style="display: block;" class="btn btn-block green-haze">
                                                        Edit  </a>
                                                    <a href="#" class="btn btn-block green-haze" id="submitButton" onclick="submitPerInfo('<?php echo $code;?>');" style="display: none;">
                                                        Save </a>
                                                </div>
                                            </form>
                                        </div>
                                        ...
                                        <div class="tab-pane" id="tab_1_2">
                                            ...
                                            <form role="form" id="editContactForm" action="#">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="mHNo" id="mHNo" type="text" value="<?php echo $row['MAddr3'];?>" maxlength="50" class="form-control" readonly/>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label class="control-label">Street No.<span class="required">					                             </span>
                                                            </label></br>
                                                            <input name="mStreetNo" id="mStreetNo" type="text" value="<?php echo $row['MAddr1'];?>" class="form-control" maxlength="50" placeholder="" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="mPhoneNo" id="mPhoneNo"  type="text" value="<?php echo $row['MPhoneNo'];?>" maxlength="15" placeholder="Numeric Values only"  class="form-control" readonly/>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label class="control-label">Personal Email Id<span class="required"></span>
                                                            </label></br>
                                                            <input type="hidden" name="" id="erroremail" value="">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6" style="padding-left: 0px;">
                                                                <input name="mobileNo" id="mobileNo" type="text" placeholder="Numeric Values only" maxlength="10" value="<?php echo $row['MobileNo'];?>" class="col-md-6 form-control" readonly/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="pHNo" id="pHNo" type="text" maxlength="100" value="<?php echo $row['PAddr1'];?>" class="form-control" readonly/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">Street No.<span class="required">					                             </span>
                                                            </label></br>
                                                            <input name="pStreetNo" id="pStreetNo" type="text" maxlength="100" value="<?php echo $row['PAddr2'];?>" class="form-control" placeholder="" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="pArea" id="pArea" type="text" maxlength="100" value="<?php echo $row['PAddr3'];?>" class="form-control" placeholder="" readonly/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">City<span class="required">					                             </span>
                                                            </label></br>
                                                            <input name="pCity" id="pCity" type="text" maxlength="50" value="<?php echo $row['PCity'];?>" class="form-control" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="control-label">Distric<span class="required">					                             </span>
                                                            </label></br>
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="pState" id="pState" type="text" maxlength="20" value="<?php echo $row['PState'];?>" class="form-control" placeholder="" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="pCountry" id="pCountry" type="text" maxlength="20" value="<?php echo $row['PCountry'];?>" class="form-control" placeholder="" readonly/>
                                                        </div>
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="col-md-6" style="padding-left: 0px;">
                                                                ...
                                                                <input name="pPhoneNo" id="pPhoneNo" type="text" placeholder="Numeric Values only" maxlength="15" value="<?php echo $row['PPhoneNo'];?>" class="col-md-6 form-control" readonly/>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-offset-9 margiv-top-10">
                                                    <a href="#" onclick="contactEnableTexts();" id="editContactButton" style="display: block;" class="btn btn-block green-haze">
                                                        Edit  </a>
                                                    <a href="#" class="btn btn-block green-haze" id="submitContactButton" onclick="submitContactInfo('<?php echo $code;?>');" style="display: none;">
                                                        Save </a>
                                                </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions"><?php $empCode= $code;?>
                                        ...
                                        if ($row_count > 0) {
                                            while ($row = $fetch($result1)) { ?>
                                                <tr class='odd gradeX'>
                                                    ...
                                                    <td><?php //if($row['Dependent'] == 1){echo "Yes";}else{ echo "No";}
                                                        echo $row['DOB'];
                                                     ?>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <a href="#portlet-config1" class="btn btn-default btn-sm" onclick="addNominee('<?php echo $code;?>');" data-toggle="modal">
                                            <i class="fa fa-pencil"></i> Add </a>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                        ...
                                        if ($row_count > 0) {
                                            while ($row = $fetch($result1)) { ?>
                                                <tr class='odd gradeX'>
                                                    ...
                                                    <td><?php echo $row['LOV_text'];?></td>
                                                    <!--<td><?php //echo $row['Nominee_Addr1'];?>
                                                    <!--</td>-->
                                                    <!--<td><?php //echo $row['Nominee_Addr2'];?>
                                                    <!--</td>-->
                                                    <td><a href="#portlet-configEdit1" class="btn btn-default btn-sm" onclick="editNominee(<?php echo $row['NomineeID']; ?>);" data-toggle="modal">
                                                            <i class="fa fa-pencil"></i> Edit </a></td>
                                                </tr>
                                            <?php }
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <a href="#portlet-config2" class="btn btn-default btn-sm" onclick="addQual('<?php echo $code; ?>');" data-toggle="modal">
                                            <i class="fa fa-pencil"></i> Add </a>
                                    </div>
                                </div>
                                <div class="portlet-body">
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="portlet box blue">
                                <div class="portlet-title">
                                    ...
                                    <div class="actions">
                                        <a href="#portlet-config3" class="btn btn-default btn-sm"onclick="addLang('<?php echo $code;?>');" data-toggle="modal">
                                            <i class="fa fa-pencil"></i> Add </a>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                        ...
                                        if ($row_count > 0) {
                                            while ($row = $fetch($result1)) { ?>
                                                <tr class='odd gradeX'>
                                                    ...
                                                    <td><a href="#portlet-configEdit3" class="btn btn-default btn-sm"  onclick="editLanguage(<?php echo $row['ResLangugesID'];?>);" data-toggle="modal">
                                                            <i class="fa fa-pencil"></i> Edit </a></td>
                                                </tr>
                                            <?php }
                            ...
                            <div class="portlet light">
                                <div class="portlet-title tabbable-line">
                                    ...
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li>
                                            <a href="#tab_1_8" data-toggle="tab"> Separation Information</a>
                                        </li>
                                        <li>
                                            <a href="#tab_1_6" data-toggle="tab">Identity Details</a>
                                        </li>
                                        <li>
                                            <a href="#tab_1_7" data-toggle="tab">Statutory Details</a>
                                        </li>

                                    </ul>
                                </div>
                                <input type="hidden" id="empCode" value="<?php echo $code;?>">
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        <!-- officialINFO TAB -->
                                            ...
                                            <form role="form" id="editOfficialForm" class="form-horizontal" action="#">
                                                <div class="" style="display:block;">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="empCode1" id="empCode1" value="<?php echo $code;?>" maxlength="20" class="input-medium form-control input-medium" readonly onchange="getEmpCode();"/>
                                                                ...
                                                                <select class="form-control input-medium select2me" name="function_supervisor" id="function_supervisor" data-placeholder="Select..." disabled>
                                                                    ...
                                                                    while($data = $fetch($resultq)) {
                                                                      ...
                                                                      foreach($emp as $key=>$value )
                                                                        {?>
                                                <option <?php if ( isset($row2['MNGR_CODE2']) && $row2['MNGR_CODE2'] == $key){echo "selected";}?> value="<?php echo $key;?>"><?php echo $value;?><?php echo " (".
                                                $key.")";?>
                                                </option>
                                                                        <?php
                                                            ...
                                                            <div class="col-md-12" style="padding: 0;">
                                                                <select class="form-control input-medium select2me " name="global_manager" id="global_manager" data-placeholder="Select..." disabled>
                                                                   ...
                                                                   <?php foreach($emp as $key=>$value )
                                                                        {?>
                                                <option <?php if (isset($row2['MNGR_CODE']) && $row2['MNGR_CODE'] == $key){echo "selected";}?> value="<?php echo $key;?>"><?php echo $value;?><?php echo " (".
                                                $key.")";?>
                                                </option>
                                                                        <?php
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">Official Email<span class="not-required"></span></label></br>
                                                            <input type="hidden" name="errofficmail" id="errofficmail" value="">
                                                            <input type="text" name="oEmail" id="oEmail" maxlength="20" onkeydown="validate.email('oEmail','errofficmail');" value="<?php echo $row2['OEMailID'];?>" class="form-control input-medium" readonly/>
                                                        </div>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="workphn" id="workphn" maxlength="10" value="<?php echo $row2['WorkPhone'];?>" class=" input-medium form-control" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="workphnExt" id="workphnExt" maxlength="10" value="<?php echo $row2['WorkPhoneExt'];?>" class=" input-medium form-control" readonly/>
                                                        </div>
                                                ...
                                                <!-- <div class="col-md-offset-9" style="margin-top: 15px;">
                                                    <a href="#" onclick="officialEnableTexts();" id="editOfficialButton" style="display: block;" class="btn btn-block green-haze">
                                                        Edit  </a>
                                                    <a href="#" class="btn btn-block green-haze" id="submitOfficialButton" onclick="submitOfficialInfo('<?php echo $code;?>');" style="display: none;">
                                                        Submit </a>
                                                </div> -->
                                            ...
                                            <form role="form" id="editBankForm" action="#">
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="smopNo" id="smopNo" type="text"  value="<?php echo $row2['SMOPNo'];?>" onkeyup="getTextLength('smopNo','19','errSmopNo');" class="form-control" placeholder="Numeric Values Only" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="rmopNo" id="rmopNo" type="text" value="<?php echo $row2['RMOPNo'];?>" onkeyup="getTextLength('rmopNo','19','errRmopNo');" readonly class="form-control" placeholder="Numeric Values Only" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <!--<div class="col-md-offset-9 margiv-top-10">
                                                    <a href="#" onclick="bankEnableTexts();" id="editBankButton" style="display: block;" class="btn btn-block green-haze">
                                                        Edit  </a>
                                                    <a href="#" class="btn btn-block green-haze" id="submitBankButton" onclick="submitBankInfo('<?php //echo $code;?>');" style="display: none;">
                                                        Save </a>
                                                </div>-->
                                            </form>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="passNo" id="passportNo" value="<?php echo $row2['PassportNo'];?>" maxlength="20" readonly type="text" class="form-control"/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">Place Of Issue<span class="not-required">
				                             </span>
                                                            </label></br>
                                                            <input name="passPlace" id="passportPlace" value="<?php echo $row2['PassportPlace']; ?>" readonly type="text" maxlength="20" class="form-control"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <!-- <input name="passAddress" id="passportAddress" readonly maxlength="100" value="<?php echo $row2['PassportAddress']; ?>" type="text" class="form-control"/> -->

             <textarea name="passAddress" id="passportAddress" readonly maxlength="100" class="form-control"><?php echo $row2['PassportAddress']; ?></textarea>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="control-label">Driving Licence No.<span class="required">               * </span>
                                                            </label></br>
                                                            <input name="dlNo" id="dlNo" type="text" readonly value="<?php echo $row2['DLNo']; ?>" maxlength="20" class="form-control"/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">Place Of Issue<span class="not-required">
				                            </span>
                                                            </label></br>
                                                            <input name="dlPlace" id="dlPlace" type="text" readonly maxlength="20" value="<?php echo $row2['DLPlace'];?>" class="form-control"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
				                            ...
				                            * </span>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="control-label">Address On Driving Licence<span class="not-required"></span>
                                                            </label></br>
                                                                                                                       
                                                            <textarea name="dlAddress" id="dlAddress" maxlength="100" class="form-control" readonly><?php echo $row2['DLAddress'];?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="adharNo" id="adharNo" type="text" readonly value="<?php echo $row2['AadharNo'];?>" maxlength="20"class="form-control"/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">Registration No.<span class="not-required" id="errorRegistr"></span></label></br>
                                                            <input name="registration" id="registration"  value="<?php echo $row2['Registration_No'];?>" type="text" class="form-control" maxlength="30" readonly/>
                                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="trade" id="trade" maxlength="20" type="text" value="<?php echo $row2['Trade'];?>" class="form-control" readonly/>
                                                        </div>
                                                ...
                                                <div class="col-md-offset-9 margiv-top-10">
                                                    <a href="#" onclick="staturyEnableTexts();" id="editStaturyButton" style="display: block;" class="btn btn-block green-haze">
                                                        Edit  </a>
                                                    <a href="#" class="btn btn-block green-haze" id="submitStaturyButton" onclick="submitStaturyInfo('<?php echo $code;?>');" style="display: none;">
                                                        Save </a>
                                                </div>
                                            </form>
                                        </div>
                                            ...
                                            <form action="#" id="editSeprationForm">
                                                ...
                                                <!--<div class="col-md-offset-9 margiv-top-10">
                                                    <a href="#" onclick="seprationEnableTexts();" id="editSepration" style="display: block;" class="btn btn-block green-haze">
                                                        Edit  </a>
                                                    <a href="#" class="btn btn-block green-haze" id="submitSepration" onclick="submitSeprationInfo('<?php echo $code;?>');" style="display: none;">
                                                        Save </a>
                                                </div>-->
                                            </form>
                                        </div>   
                                        ...
                                        <div class="tab-pane" id="tab_1_7">
                                            <form action="#" id="editIdentityForm">
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="control-label">UAN No.<span class="not-required"></span></label></br>
                                                            <input name="uanNo" id="uanNo" type="text" value="<?php echo $row2['UNNo'];?>" class="form-control" maxlength="20" readonly/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">PF No.<span class="required">*</span></label></br>
                                                            <input name="PfNo" id="PfNo" type="text" value="<?php echo $row2['PFNo'];?>" class="form-control" maxlength="20" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="panNo" id="panNo" type="text" readonly  value="<?php echo $row2['PANNo'];?>" maxlength="20" class="form-control"/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">ESI No.<span class="required">*</span>
                                                            </label></br>
                                                            <input name="esiNo" id="esiNo" type="text" value="<?php echo $row2['ESINo'];?>" class="form-control" maxlength="20" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <!--<div class="col-md-offset-9 margiv-top-10">
                                                    <a href="#" onclick="identityEnableTexts();" id="editIdentityButton" style="display: block;" class="btn btn-block green-haze">
                                                        Edit  </a>
                                                    <a href="#" class="btn btn-block green-haze" id="submitIdentityButton" onclick="submitIdentityInfo('<?php echo $code;?>');" style="display: none;">
                                                        Save </a>
                                                </div>-->
                                            </form>
                                        </div>
                                        ...
                                        <div class="tab-pane active" id="">
                                            ...
                                            <form action="#" id="uploadimage" method="post" enctype="multipart/form-data" role="form">
                                                ...
                                                <div class="margin-top-10">
                                                    ...
                                                    <a href="#" onclick="submitImage('<?php echo $code;?>');" class="btn green-haze">
                                                        Save </a>
                                                </div>
                                            </form>
