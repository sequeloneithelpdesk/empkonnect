...
$c_val["Time Management"]["Out On Work Request"] = 'end1234';
?>
<!DOCTYPE html>
...
<script>
    ...
    function applyAction(code,status) {
            ...
            $.ajax({
                type: "POST",
                url: "ajax/markPastAtten_ajax.php",
                data: {userCode :  code, type: type, status:status, inputval:inputval},
                success: function (result) {
                    //
                    if(result == 1){
                        location.reload();
    ...
    function searchByDate(dateval,code){
        var type="searchDate";
        $.ajax({
            type:"POST",
            url:"ajax/markPastAtten_ajax.php",
            data:{type:type, dateval:dateval, code:code},
            success: function(result){
                if(result){
                    //location.reload();
                    $("#searchData").html(result);
