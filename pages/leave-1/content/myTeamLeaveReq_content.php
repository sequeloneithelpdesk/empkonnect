                          ...
                          $leaveID= $getMyTeamLeaveRequestDataManager[0];
                            ...
                            for ($i=0;$i<$count_flag;$i++){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo str_replace('\' ', '\'', ucwords(str_replace('\'', '\' ', strtolower($leave_class_obj->getemployee_name($CreatedBy[$i])))));?>
                                    </td>
                                     <td>
                                        <?php
                                        $mngrcode=  $ApprovedBy[$i];
                                       
                                        echo str_replace('\' ', '\'', ucwords(str_replace('\'', '\' ', strtolower($leave_class_obj->getemployee_name($mngrcode)))));
                                        ?>
                                    </td>
                                    <td>
                                        <?php echo $LvFrom[$i]."    ".$leaveID[$i];?>
                                    </td>
