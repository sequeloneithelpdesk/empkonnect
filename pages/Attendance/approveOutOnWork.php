...
<div class="page-content-wrapper cus-dark-grey">
    ...
    <div class="page-container">
        ...
        <!-- END SIDEBAR -->
        <!-- BEGIN CONTENT -->
        <?php include ('content/approveOutOnWork_content.php');?>
...
<script>
    ...
    function getmyodId(myodId,status,code){
        ...
        $.ajax({
            type: "POST",
            url: "content/view_approveODRequest.php",
