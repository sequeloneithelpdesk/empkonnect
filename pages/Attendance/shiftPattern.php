...
$c_val["Time Management"]["Manager Shift Pattern"] = 'end1234';
?>
                ...
                <div class="tab-pane" id="tab_4">
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>Shift Pattern
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="btn-group">
                                            ...
                                            <a class="btn green" onclick="myFunction('NA');">Add New <i class="fa fa-plus"></i></a>
                                        </div>
                                    </div>
...
<script>
    ...
    SM.init('ShiftPatternMast','ShiftPattern','sample_2','1','Shift Pattern');
    function myFunction(ShiftPatternMastId){
        $.ajax({url: "content/shiftPattern_content.php?ShiftPatternMastId="+ShiftPatternMastId,
            cache: false,
            beforeSend: function(){
                loading();
            },
