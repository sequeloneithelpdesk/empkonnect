...
<html lang="en">
	...
	<head>
		...
		<style>
			...
			.red, .red2, .green,.green2,.green_over,.red_over,.yellow,.yellow_over,.blue_over,.pink,.presentAbsent,.miss-punch{
				height: 108px;
			    margin-left: -1px;
			    margin-right: -1px;
			    margin-top: -23px;
			...
			.green_over,.red_over,.yellow_over,.green2,.red,.miss-punch {
...
<select name="teamMembers" class="jq_teamMembersCalendar form-control select2me">
