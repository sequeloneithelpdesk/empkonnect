                                    ...
                                    <form action="#" class="form-horizontal" id="outWorkForm">
                                        <div class="form-body">
                                            ...
                                            <?php $currDate = date("d/m/Y");?>
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control input-medium pull-left" name="fromDate" id="fromDate" onchange="selectDate(this.value,'<?php echo $currDate?>','<?php echo $code; ?>');" placeholder="dd/mm/yy">
                                                    <label id="jq-timeLoading" style="display:none; margin-left: 10px; margin-top: 5px;"><img atl="Loading..." src="../../assets/global/img/loading-spinner-blue.gif"></label>
