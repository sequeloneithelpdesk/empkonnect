...
<html lang="en">
	...
	<head>
		...
		<style>
			...
			.red, .red2, .green,.green2,.green_over,.red_over,.yellow,.yellow_over,.blue_over,.pink,.presentAbsent {
				height: 108px;
			    margin-left: -1px;
			    margin-right: -1px;
			    margin-top: -23px;
												...
												<?php if(isset($_GET['type']) && !empty($_GET['type']) && $_GET['type'] =='grpcal' || $_GET['type'] =='grpsum'){
													...
													<div class="col-md-2">
														...
														<?php 
																																															...
																																															$where = ($emp_code == 'admin')?'':"WHERE MNGR_CODE = ".$emp_code;
																																													...
																																													<select name="teamMembers" class="jq_teamMembersCalendar form-control">
																																													<option value="<?php echo $empcode; ?>"><?php echo $empname.' ('.$emp_code.')'; ?></option>																																			<?php 
																																																while ($teamMembers = $fetch($teamMembersQueryResult)) {
																																																			?>
																																																			<option value="<?php echo $teamMembers['Emp_Code']; ?>"><?php echo ucwords($teamMembers['EMP_NAME']).' ('.$teamMembers['Emp_Code'].')'; ?></option>
																																																			<?php
																																																}
																																																?>
																																																</select>
