...
$c_val["Admin"]["Announcement and Notification"]["MyTeam Notification"] = 'end1234';
            ...
            <div class="page-content cus-light-grey">
                ...
                <div class="page-bar z-depth-1">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <a href="#">Reporting Notification</a>
                        </li>
                    </ul>
                ...
                <!-- END PAGE HEADER-->
                <!-- BEGIN PAGE CONTENT-->
                <?php  include('content/reportingNotification_content.php'); ?>
                <!-- END PAGE CONTENT -->
            </div>
        </div>
        <!-- END CONTENT -->
