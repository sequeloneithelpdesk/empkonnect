...
include('../../configdata.php');
    ...
    $default_password_expiry_status = $_POST['default_password_expiry_status'];
     ...
     $sql = "Update PasswordPolicy set password_length='$pass_length',alphabet_radio='$alpha_radio',uppercase_radio='$uppercase_radio',
            ...
            ask_for_otp='$ask_for_otp',ask_for_otp_status='$ask_for_otp_status',
            default_password_status='$default_password_status',default_password='$default_password',default_password_expiry_status='$default_password_expiry_status',default_password_expiry='$default_password_expiry',status='1'";
