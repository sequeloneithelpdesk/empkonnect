...
<div class="clearfix">
		...
		<div class="page-content-wrapper">
			<div class="page-content cus-light-grey">
				...
				<!-- END PAGE HEADER-->
				<!-- BEGIN PAGE CONTENT-->
				<?php  include('content/policiesandforms_content.php'); ?>
				<!-- END PAGE CONTENT -->
			</div>
		</div>
		<!-- END CONTENT -->
...
<script type="text/javascript">
	function getSUbPolicies(id)
	{
		...
		$.ajax({
                type: "POST",
                url: "ajax/subPolicies_ajax.php?id="+id,
               // data: {},
                beforeSend: function(){
                loading();
            },
