...
$.extend(DayGrid.prototype, {
	...
	renderSegHtml: function(seg, disableResizing) {
		...
		if(event.type=='attendance'){
			...
			titleHtml +='<span class="att-time">'+event.status+'</span>';
		}else if(event.type=='attRegularised'){
			titleHtml +='<span class="att-time">'+event.startTime+'-'+event.endTime+'</span><br><span class="att-time">'+event.status+'</span>';
