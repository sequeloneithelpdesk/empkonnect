                ...
                if($num($resultq)) {
                    ...
                    while ($rowq = $fetch($resultq)) {
                        ...
                        <ul style="list-style: none;">
                            ...
                            <!--<li id="alphabet_char" class="invalid" value="<?php /*echo $rowq['num_alphabets']; */?>">At least <strong><?php /*echo $rowq['num_alphabets']; */?>  Alphabet</strong>-->
