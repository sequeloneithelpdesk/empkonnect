...
$searchTerm = $_GET['term'];
 $manager_teamsearch = $_GET['extraParams'];
$male='images.png';
$female='images.jpg.jpg';
//get matched data from skills table
$sqlq="SELECT * FROM HrdMastQry WHERE (MNGR_CODE='$manager_teamsearch') AND ((Emp_Code LIKE '%".$searchTerm."%') OR (EMP_NAME LIKE '%".$searchTerm."%')) ORDER BY EMP_NAME ASC";
