...
<form action="#" id="editAddLangForm" class="form-horizontal">
        ...
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-3">
                    ...
                    <input type="checkbox" name="read" onclick="check('read1');" class="form-control" value="N" id="read1" style="width: 20PX;"/>
                </div>
                <div class="col-md-3">
                    <label class="control-label">Write<span class="not-required">
                            </span>
                    </label>
                    <input type="checkbox" name="write" onclick="check('write1');" class="form-control" value="N" id="write1" style="width: 20PX;"/>
                </div>
                <div class="col-md-3">
                    <label class="control-label">Speak<span class="not-required">
                             </span>
                    </label>
                    <input type="checkbox" name="speak" onclick="check('speak1');" class="form-control" value="N" id="speak1" style="width: 20PX;"/>
                </div>
                <div class="col-md-3">
                    <label class="control-label">Understand<span class="not-required">
                            </span>
                    </label>
                    <input type="checkbox" name="understand"  onclick="check('understand1');" class="form-control" value="N" id="understand1" style="width: 20PX;"/>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-md-12">
                <div class="col-md-3">
                    ...
                    <input type="checkbox" name="motherTongue" onclick="check('motherTongue23');" class="form-control"  value="N" id="motherTongue23" style="width: 20PX;"/>
                </div>
            </div>
        </div>
