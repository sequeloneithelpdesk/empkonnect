            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header portlet box blue">
                        ...
                        <h4 class="modal-title white-xt">Add Relative Details</h4>
                    </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                               ...
                                               <?php }else{
                                                ...
                                                <?php }?>
                                                     <input name="gaurdian" id="gaurdian" type="text" class="form-control" value="<?php echo $row['GuardianName'];?>"  readonly/>
                                                </div>
                                            </div>
                                ...
                                <!-- officialINFO TAB -->
                                 <div class="tab-pane active" id="tab_1_4">
                                            <form role="form" id="editOfficialForm" class="form-horizontal" action="#">
                                                            ...
                                                            <div class="col-md-12" style="padding: 0;">
                                                                <select class="form-control input-medium select2me" name="function_supervisor" id="function_supervisor" data-placeholder="Select..." disabled>
                                                                    ...
                                                                    while($data = $fetch($resultq)) {
                                                                        ?>
                                                                        <option <?php if($row2['MNGR_CODE2']== $data['Emp_Code']){echo "selected";}?> value="<?php echo $data['Emp_Code'];?>"><?php echo $data['Emp_FName'];?> <?php echo $data['Emp_MName'];?> <?php echo $data['Emp_LName'];?>
                                                                        </option>
                                                                        <?php
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-12" style="padding: 0;">
                                                                <select class="form-control input-medium select2me " name="global_manager" id="global_manager" data-placeholder="Select..." disabled>
                                                                    ...
                                                                    while($data = $fetch($resultq)) {
                                                                        ?>
                                                                        <option <?php if($row2['MNGR_CODE']== $data['Emp_Code']){echo "selected";}?> value="<?php echo $data['Emp_Code'];?>"><?php echo $data['Emp_FName'];?> <?php echo $data['Emp_MName'];?> <?php echo $data['Emp_LName'];?>
                                                                        </option>
                                                                        <?php
                                                ...
                                                <input type="hidden" name="gaurdian" value="<?php echo $row2['GuardianName']; ?>">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input name="registration" id="registration"  value="<?php echo $row2['Registration_No'];?>" type="text" maxlength="20" class="form-control" readonly/>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input name="trade" id="trade" type="text" value="<?php echo $row2['Trade'];?>" maxlength="20" class="form-control" readonly/>
                                                </div>
                                                <!--<div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <input name="uanNo" id="uanNo" type="text" value="<?php echo $row2['UNNo'];?>" maxlength="20" class="form-control" readonly/>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="control-label">PF No.<span class="required"></span></label></br>
                                                    <input name="PfNo" id="PfNo" type="text" value="<?php echo $row2['PFNo'];?>" maxlength="20" class="form-control" readonly/>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <input name="esiNo" id="esiNo" type="text" value="<?php echo $row2['ESINo'];?>" maxlength="20" class="form-control" readonly/>
                                                </div>
                                            </div>
                                        </div>
