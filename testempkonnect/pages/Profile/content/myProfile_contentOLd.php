    ...
    <div class="page-content cus-light-grey">
        ...
        <div class="portlet box blue">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>Employee My Profile
                </div>
                <div class="tools">
...
<!--                                <li onclick="showPassword();" id="change_pass">-->
<!--                                    <a href="#">-->
                            ...
                            <div class="portlet light">
                                <div class="portlet-title tabbable-line">
                                    ...
                                    <ul class="nav nav-tabs">
                                        <li class="active">
                                            <a href="#tab_1_1" data-toggle="tab">Personal Infomation</a>
                                        </li>
                                        <li>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select  name="nationality" id="nationality" class="form-control" disabled>
                                                                <option value=""></option>
                                                                <?php $sql="select * From lovmast where LOV_Field='NATIONALITY'";
                                                                        $res = query($query,$sql,$pa,$opt,$ms_db);
                                                                while($ro = $fetch($res)){
                                                                ?>
                                                                <option <?php if($row['Nationality']== $ro['LOV_Value']){ echo "selected";}  ?> value="<?php echo $ro['LOV_Value'];?>"><?php echo $ro['LOV_Text'];?></option>
                                                                <?php } ?>
                                                            </select>
<!--                                                            <input type="text" name="nationality" id="nationality" value="--><?php //echo $row['Nationality'] ?><!--" class="form-control" readonly/>-->
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select  name="religion" id="religion" class="form-control" disabled>
                                                                <option value=""></option>
                                                                <?php $sql1="select * From lovmast where LOV_Field='Religon'";
...
<!--                                                            <input name="religion" id="religion" type="text" value="--><?php //echo $row['Religion'];?><!--" class="form-control" readonly/>-->
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <select  name="bloodGroup" id="bloodGroup" class="form-control" disabled>
                                                                <option value=""></option>
                                                                <?php $sql2="select * From lovmast where LOV_Field='BloodGroup'";
                                                                $res2 = query($query,$sql2,$pa,$opt,$ms_db);
                                                                while($ro2 = $fetch($res2)){
                                                                    ?>
                                                                    <option <?php if($row['BloodGroup']== $ro2['LOV_Value']){ echo "selected";}  ?> value="<?php echo $ro2['LOV_Value'];?>"><?php echo $ro2['LOV_Text'];?></option>
                                                                <?php } ?>
                                                            </select>
                                                           <!-- <input name="bloodGroup" id="bloodGroup" type="text" value="<?php //echo $row['BloodGroup'];?>" class="form-control" readonly/>-->
                                                        </div>
                                                        <?php if($row['MStatus']== 2){?>
                                                            <div class="col-md-6">
                                                                <label class="control-label">Spouse Name<span class="not-required"></span></label></br>
                                                ...
                                                <div class="col-md-offset-9 margiv-top-10">
                                                    <a href="#" onclick="perEnableTexts();" id="editButton" style="display: block;" class="btn btn-block green-haze">
                                                        Edit  </a>
                                                    <a href="#" class="btn btn-block green-haze" id="submitButton" onclick="submitPerInfo('<?php echo $empCode ?>');" style="display: none;">
                                                        Update </a>
                                                </div>
                                            </form>
                                        </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="mPin" id="mPin" type="text" value="<?php echo $row['MPin'];?>" class="form-control" placeholder="Numeric Values Only" maxlength="6" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="mPhoneNo" id="mPhoneNo"  type="text" value="<?php echo $row['MPhoneNo'];?>"  placeholder="Numeric Values Only" class="form-control" readonly/>
                                                        </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6" style="padding-left: 0px;">
                                                                <input name="mobileNo" id="mobileNo" type="text" value="<?php echo $row['MobileNo'];?>"  placeholder="Numeric Values Only" class="col-md-6 form-control" readonly/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="pCountry" id="pCountry" type="text" value="<?php echo $row['PCountry'];?>" class="form-control"  readonly/>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="control-label">Pincode<span class="required" id="errPPin">					                             </span>
                                                            </label></br>
                                                            <input name="pPin" id="pPin" type="text" value="<?php echo $row['PPin'];?>" maxlength="6" class="form-control" placeholder="Numeric Values Only" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="col-md-6" style="padding-left: 0px;">
                                                                ...
                                                                <input name="pPhoneNo" id="pPhoneNo" type="text" value="<?php echo $row['PPhoneNo'];?>"  placeholder="Numeric Values Only" class="col-md-6 form-control" readonly/>
                                                            </div>
                                                        </div>
                                                                        ...
                                                                        if ($row_count > 0) {
                                                                            while ($row = $fetch($result1)) { ?>
                                                                                <tr class='odd gradeX'>
                                                                                    ...
                                                                                    <td><a href="#portlet-configEdit1" class="btn btn-default btn-sm" onclick="editNominee(<?= $row['NomineeID']?>);" data-toggle="modal">
                                                                                            <i class="fa fa-pencil"></i> Edit </a></td>
                                                                                </tr>
                                                                            <?php }
                                                            ...
                                                            <div class="portlet box blue">
                                                                ...
                                                                <div class="portlet-body">
                                                                    <table class="table table-striped table-bordered table-hover" id="sample_2">
                                                                        ...
                                                                        <?php
                                                                        $empCode= $code;
                                                                        $sql1 = "Select * FROM HrdQual WHERE EMP_CODE='$empCode'";
                                                                        $result1 = query($query,$sql1,$pa,$opt,$ms_db);
                                                                        $row_count = $num( $result1 );
                                                                        if ($row_count > 0) {
                                                                            while ($row = $fetch($result1)) { ?>
                                        ...
                                        <div class="tab-pane active" id="tab_1_4">
                                            <form role="form" id="editOfficialForm" class="form-horizontal" action="#">
                                                <div class="" style="display:block;">
                                                    <div class="row">
                                                        <?php
                                                        $sql2 = "select *,convert(varchar(10),DOB,103) as DOB,convert(varchar(10),DOC,103) as DOC,convert(varchar(10),DOJ,103)as DOJ ,
...
CONVERT(varchar(10),PassportValidityDate,103 )AS PassportValidityDate,CONVERT(varchar(10),PassportValidityDate,103 )AS PassportValidityDate,CONVERT(varchar(10),DLValidityDate,103 )AS DLValidityDate  from HrdMastQry WHERE Emp_Code='$empCode'";
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <input type="text" name="empCode1" id="empCode1" value="<?php echo $empCode;?>" maxlength="20" class="input-medium form-control input-medium" readonly onchange="getEmpCode();"/>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">Date Of Joining <span class="not-required"></span></label></br>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            ...
                                                            <input name="dojWef" id="dojWef" type="text" disabled value="<?php echo $row2['DOC']; ?>"  class="input-medium form-control" placeholder="DD/MM/YYYY"/>
                                                        </div>
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-12" style="padding: 0;">
                                                                <select class="form-control input-medium select2me" name="function_supervisor" id="function_supervisor" data-placeholder="Select..." disabled>
                                                                    ...
                                                                    while($data = $fetch($resultq)) {
                                                                        ?>
                                                                        <option <?php if($row2['Emp_FName']== $data['Emp_FName']){echo "selected";}?> value="<?php echo $data['Emp_Code'];?>"><?php echo $data['Emp_FName'];?><?php echo $row['Emp_MName'];?><?php echo $row['Emp_LName'];?>
                                                                        </option>
                                                                        <?php
                                                                        $i++;
                                                                    }?>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="control-label">Global Manager</label>
                                                            <div class="col-md-12" style="padding: 0;">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <select name="compCode" id="compCode" class="form-control input-medium select2me" data-placeholder="Select..." disabled>
                                                                ...
                                                                $result = query($query,$sql,$pa,$opt,$ms_db);
                                                                if ($num($result) > 0) {
                                                                    while($data = $fetch($result)) { echo $row2['COMPID'];?>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">Work Location<span class="not-required"></span>
                                                            </label></br>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">Grade<span class="not-required"></span>
                                                            </label></br>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="control-label">Employee Type<span class="not-required"></span>
                                                            </label></br>
                                                            ...
                                                            <select name="empTypeCode" id="empTypeCode" class="form-control input-medium select2me" data-placeholder="Select..." disabled>
                                                                ...
                                                                if ($num($result) > 0) {
                                                                    while($data =$fetch($result)) {?>
                                                                        <option <?php if($row2['TYPE_CODE']== $data['TYPEID']){}?> value=<?php echo $data['TYPEID'];?> ><?php echo $data['TYPE_NAME']; ?></option>
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <label class="control-label">Function<span class="required"></span>
                                                            </label></br>
                                                            ...
                                                            <select name="subFunctCode" id="subFunctCode" class="form-control input-medium select2me" data-placeholder="Select..." disabled>
                                                                ...
                                                                if ($num($result) > 0) {
                                                                    ...
                                                                    while($row =$fetch($result)) {
                                                                        $list.= "<option value=" . $row['SubFuntId']. ">" . $row['SubFunct_NAME']. "</option>";
                                                                    }
                                                                    echo $list;
                                                                }
                                                                ?>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">Process<span class="not-required"></span>
                                                            </label></br>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">Designation<span class="not-required"></span>
                                                            </label></br>
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="control-label">Label<span class="not-required"></span>
                                                            </label></br>
                                                            <!-- <input name="roleCODE" id="roleCODE" type="text" class="form-control" placeholder=""/>-->
                                                            <select name="lavel" id="lavel" class="form-control input-medium select2me" data-placeholder="Select..." disabled>
                                                                ...
                                                                if ($num($result)> 0) {
                                                                    while($data =$fetch($result)) {?>
                                                                        <option <?php if($row2['Level_CODE']==$data['LEVELID']){echo "selected"; }?>value=<?php echo $data['LEVELID'];?> ><?php echo $data['LEVEL_Name'];?></option>
                                                                    <?php  }
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">Division Master<span class="not-required"></span>
                                                            </label></br>
                                                            <select name="divisionMast" id="divisionMast" class="form-control input-medium select2me" data-placeholder="Select..." disabled>
                                                                <option value=""></option>
                                                                <?php $sql="DIVIID, DIVI_NAME from DiviMast";
                                                                $result = query($query,$sql,$pa,$opt,$ms_db);
                                                                if ($num($result) > 0) {
                                                                    while($data =$fetch($result)) {?>
                                                                        <option <?php if($row2['DIVI_NAME']==$data['DIVI_NAME']){echo "selcted";}?>value="<?php echo $data['DIVIID'];?>" ><?php echo $data['DIVI_NAME'];?></option>
                                                                    <?php    }
                                                                }
                                                                ?>
                                                            </select>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">Region Master<span class="not-required"></span>
                                                            </label></br>
                                                            <!-- <input name="costCode" id="costCode" type="text" class="form-control" placeholder=""/>-->
                                                            <select name="regionMast" id="regionMast" class="form-control input-medium select2me" data-placeholder="Select..." disabled>
                                                                ...
                                                                if ($num($result) > 0) {
                                                                    ...
                                                                    while($data =$fetch($result)) {?>
                                                                        <option <?php if($row2['REGN_NAME']==$data['REGN_NAME']){echo "selected";} ?>value="<?php echo $data['REGNID'];?>"><?php echo $data['REGN_NAME'];?> </option>;
                                                ...
                                                <div class="">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <label class="control-label">Sub Bussiness Unit<span class="not-required"></span>
                                                            </label></br>
                                                        ...
                                                        <div class="col-md-4">
                                                            <label class="control-label">Work Phone<span class="not-required" id="errorworkphn"></span></label></br>
                                                            <input type="text" name="workphn" id="workphn" value="<?php echo $row2['WorkPhone'];?>" class=" input-medium form-control" readonly/>
                                                        </div>

                                                        <div class="col-md-4">
                                                            <label class="control-label">Work Phone Extention<span class="not-required" id="errorworkphnExt"></span></label></br>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="smopNo" id="smopNo" type="number"  value="<?php echo $row2['SMOPNo'];?>" onkeyup="getTextLength('smopNo','19','errSmopNo');" class="form-control" placeholder="" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="rmopNo" id="rmopNo" type="text" value="<?php echo $row2['RMOPNo'];?>" onkeyup="getTextLength('rmopNo','19','errRmopNo');" readonly class="form-control" readonly/>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="tab-pane" id="tab_1_6">
                                            <form action="#" id="editStaturyForm">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="control-label">Passport No.<span class="not-required"></span>
                                                            </label></br>
                                                            <input name="passNo" id="passportNo" value="<?php echo $row2['PassportNo'];?>" readonly type="text" class="form-control"/>
                                                        </div>

                                                        <div class="col-md-6">
                                                            <label class="control-label">Place Of Issue<span class="not-required"></span>
                                                            </label></br>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="control-label">Passport Validity<span class="not-required"></span>
                                                            </label></br>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="control-label">Address On Passport<span class="not-required"><span>
                                                            </label></br>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="control-label">DL Validity<span class="required">*</span>
                                                            </label></br>
                                                            <input name="dlValidityDate" id="dlValidityDate" disabled value="<?php echo $row2['DLValidityDate'];?>" type="text" class="form-control"/>
                                                        </div>
                                                    </div>
                                                </div> <div class="form-group">
                                                    <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            ...
                                                            <input name="uanNo" id="uanNo" type="text" value="<?php echo $row2['UANNo'];?>" class="form-control" readonly/>
                                                        </div>
                                                        <div class="col-md-6">
                ...
                <div class="profile-content" style="display: none;" id="change_password">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="portlet light">
                                ...
                                <div class="portlet-body">
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            <form role="form" action="#">
                                                <div class="form-group" id="Password_Reset_DIV">
                                                    <div class="row">
                                                        <div class="col-md-12" >
                                                            <label class="control-label" style="padding-left: 15px;">Old Password</label><span style="color:#FF0000;" id="oldpasserror"></span><br>
                                                            <div class="col-md-6">
                                                                <input type="password"  id="opass" value="" class="validate form-control" onKeyUp="oldPassword_Validation('<?php echo $code;?>');" />
                                                            </div>
                                                        </div>

                                                        <div class="col-md-12" >
                                                            <label class="control-label" style="padding-left: 15px;">New Password</label><br>
                                                            <div class="col-md-6">
                                                                <input id="new_password" type="password" class="validate form-control" onKeyUp="password_Validation();">
                                                                <input id="newpass" type="hidden" value="" />
                                                            </div>

                                                        </div>
                                                        <div class="col-md-12" >
                                                            <label class="control-label" style="padding-left: 15px;">Confirm Password</label><span style="color:#FF0000;" id="confirmerror"></span></label><br>
                                                            <div class="col-md-6">
                                                                <input id="confirm_password" type="password" class="validate form-control" onblur="confirmpassword_Validation();">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group"  >
                                                    <div class="row">
                                                        ...
                                                        <div id="showMsg" class="col-md-6" style="color:red;">
                                                        </div>
                                    ...
                                    <div class="col-md-offset-9 margiv-top-10">
                                        <button type="button" id="forgot-att" onclick="change_Password('<?php echo $code;?>')" class="btn btn-block green-haze">Change Password</button>
                                    </div>
                                    </form>
                                </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="fileinput fileinput-new" data-provides="fileinput">
                                                        <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                            <img src="upload_images/change_img.png" alt=""/>
                                                        </div>
