                                        ...
                                        <div class="tab-pane" id="tab_1_2">
                                            ...
                                            <form role="form" id="editContactForm" action="#">
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <label class="control-label">Region<span class="required">                                               </span>
                                                            </label></br>
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="control-label">Personal EmailId<span class="required"></span>
                                                            </label></br>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            ...
                                                            <div class="col-md-6" style="padding-left: 0px;">
                                                                <input name="mobileNo" id="mobileNo" type="text" placeholder="Numeric Values only" maxlength="15" value="<?php echo $row['MobileNo'];?>" class="col-md-6 form-control" readonly/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                            ...
                                                            <div class="col-md-12" style="padding: 0;">
                                                                <select class="form-control input-medium select2me" name="function_supervisor" id="function_supervisor" data-placeholder="Select..." disabled>
                                                                    ...
                                                                    while($data = $fetch($resultq)) {
                                                                        ?>
                                                                        <option <?php if($row2['MNGR_CODE2']== $data['Emp_Code']){echo "selected";}?> value="<?php echo $data['Emp_Code'];?>"><?php echo $data['Emp_FName'];?><?php echo $row['Emp_MName'];?><?php echo $row['Emp_LName'];?>
                                                                        </option>
                                                                        <?php
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="col-md-12" style="padding: 0;">
                                                                <select class="form-control input-medium select2me " name="global_manager" id="global_manager" data-placeholder="Select..." disabled>
                                                                    ...
                                                                    while($data = $fetch($resultq)) {
                                                                        ?>
                                                                        <option <?php if($row2['MNGR_CODE']== $data['Emp_Code']){echo "selected";}?> value="<?php echo $data['Emp_Code'];?>"><?php echo $data['Emp_FName'];?><?php echo $row['Emp_MName'];?><?php echo $row['Emp_LName'];?>
                                                                        </option>
                                                                        <?php
