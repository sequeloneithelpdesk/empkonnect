...
elseif ($_GET['type']=="editOfficial") {
   ...
   elseif($data['record'] == 0) {
       ...
       if ($result3) {
           $sql4 = "INSERT INTO HrdTran (Emp_Code,Trn_WEF,Trn_Date , Grd_Code,Dsg_Code,Comp_Code, Loc_Code, Cost_Code, Proc_Code, Funct_Code, SFUNCT_CODE, WLOC_CODE, BussCode, Type_Code, Mngr_Code, Mngr_Code2, Regn_Code, Divi_Code, Level_CODE, SubBuss_ID,WorkPhone, WorkPhoneExt)
       VALUES ('$empCode','$effectiveDate',CONVERT(date, getdate()), '$grdCode','$dsCODE', '$compCode', '$locCode', '$costCode', '$procCode', '$functCode', '$subFunctCode', '$wLocCode', '$bussCode', '$empTypeCode', '$mngrCode', '$mngrCode2', '$regionMast', '$divisionMast', '$lavel', '$subBussUnit','$workphn','$workphnExt')";
