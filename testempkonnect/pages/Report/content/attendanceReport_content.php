                                ...
                                <div class="col-md-12">
                                    <div class="col-md-3">
                                            ...
                                            <select class="form-control" onchange="showfunction(this.value)" style="margin-top: 25px;" id="mainselect">
                                                <option value="">Attendance Reports</option>
                                                <option value="1">Detail Summary</option>
                                                <option value="2">IN & OUT</option>
                                                <option value="3">Monthly Attendance</option>
                                                <option value="4">Missing Punch</option>
                                            </select>
                                       
                                    </div>
                                    <div class="col-md-4" style="display: none" id="month_div">
                                       
                                            <select class="form-control" style="margin-top: 25px;" id="selectmonth">
                                ...
                                <div class="form-group" id="multisearch3" style="display: none">    
                                 ...
                                 <div class="form-group">    
                                    <div class="col-md-12" >
                                        ...
                                        <div class="col-md-4" style="margin-top: 25px;;margin-left: 400px">
                                            <button type="button" class="btn  bg-blue" onclick="attReport();">Generate Report</button>
                                        </div>
