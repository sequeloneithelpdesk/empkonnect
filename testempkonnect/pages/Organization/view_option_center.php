...
<div class="clearfix">
					...
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								...
								<h4 class="modal-title"><div class="caption"><b>Add Option Center</b></div></h4>
							</div>
        ...
        <div class="modal fade bs-modal-lg" id="large1" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
								<h4 class="modal-title"><div class="caption"><b>Edit Option Center Details</b></div></h4>
							</div>
							<div class="modal-body">                
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Option Center List
								</div>
								<div class="tools">
        ...
        $sql = "SELECT * FROM CostMast";
        $result=query($query,$sql,$pa,$opt,$ms_db);
        //if ($result->num_rows > 0) {
        $list="";
        while($row = $fetch($result)) {
            $costCode = $row['COST_CODE'];
            $list.= "<tr class='odd gradeX'><td>" . $row['COST_CODE']. "</td><td>" . $row['COST_NAME']. "</td><td style='white-space: nowrap'><a class='btn' data-toggle='modal' href='#large1' onclick=\"myFunction('$costCode');\">Edit</a></td></tr>";
        }
        echo $list;
//        } else {
...
<script src="js/add/add_cost_center_validation.js"></script>
<script src="js/edit/edit_cost_center_validation.js"></script>
