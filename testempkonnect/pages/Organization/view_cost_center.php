...
?>
<?php $c_val["Admin"]["Organization Structures"]["Cost Master"] = 'end1234'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
					...
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								...
								<h4 class="modal-title"><div class="caption"><b>Add Cost Center</b></div></h4>
							</div>
							<div class="modal-body">                
                <?php include ("content/add/add_cost_center.php"); ?>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Cost Center List
								</div>
								<div class="tools">
...
</script> <script src="../js/table-excel.js">

</script>  <script src="js/common_bu.js" type="text/javascript"></script>
...
BU.init('CostMast','Cost','sample_2','1','Cost');

	function myFunction(oldCostCode){
		//alert (costCode);
		$.ajax({url: "content/edit/edit_cost_center.php?oldCostCode="+oldCostCode, success: function(result){
			console.log(result);
			$('#edit').show();
			$('#edit').html(result);
			$('#large1').modal('show');
