...
$c_val["Admin"]["Organization Structures"]["Region"] = 'end1234'; 
?>
<!DOCTYPE html>
<html lang="en">
<head>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Region List
								</div>
								<div class="tools">
...
BU.init('RegnMast','Regn','sample_2','1','Region');
function myFunction(oid){
		$.ajax({url: "content/edit/edit_region.php?oid="+oid, success: function(result){
			console.log(result);
			$('#edit').show();
			$('#edit').html(result);
			$('#large1').modal('show');
