...
$c_val["Admin"]["Organization Structures"]["Sub Functions"] = 'end1234'; 
?>
<!DOCTYPE html>
<html lang="en">
<head>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Sub Function List
								</div>
								<div class="tools">
...
<script src="js/add/add_sub_function_validation.js"></script>
<script src="js/edit/edit_sub_function_validation.js"></script>
...
BU.init('SubFunctMast','SubFunct','sample_2','1','Sub-Function');
	function myFunction(wlid){
		$.ajax({url: "content/edit/edit_sub_function.php?pagetype=edit_sub_function&Id="+wlid,
cache: false,
			 beforeSend: function(){
				 loading();
			 },
