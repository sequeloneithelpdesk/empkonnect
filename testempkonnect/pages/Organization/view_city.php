...
?>
<?php $c_val["Admin"]["Organization Structures"]["City"] = 'end1234'; ?>
<!DOCTYPE html>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View city List
								</div>
								<div class="tools">
...
BU.init('CityMast','City','sample_2','1','City');

function myFunction(oid){
		$.ajax({url: "content/edit/edit_city.php?pagetype=editCity&cityId="+oid,
			cache: false,
			 beforeSend: function(){
				 loading();
			 },
