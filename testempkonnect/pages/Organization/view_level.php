...
?>
<?php $c_val["Admin"]["Organization Structures"]["Level"] = 'end1234'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
					...
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								...
								<h4 class="modal-title"><div class="caption"><b>Add New Level</b></div></h4>
							</div>
							<div class="modal-body">                
                <?php include ("content/add/add_level.php"); ?>
				...
				<div class="modal fade bs-modal-lg" id="large1" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
								<h4 class="modal-title"><div class="caption"><b>Edit Level</b></div></h4>
							</div>
							<div class="modal-body">                
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Level List
								</div>
								<div class="tools">
...
<script src="js/add/add_level_validation.js"></script>
<script src="js/edit/edit_level_validation.js"></script>
...
BU.init('LEVELMAST','LEVEL','sample_2','1','LEVEL');
</script>
</body>
<!-- END BODY -->
</html>
