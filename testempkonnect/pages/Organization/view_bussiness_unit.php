					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Business Unit List
								</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="table-toolbar">
									<div class="row">
										<div class="col-md-6">
											<div class="btn-group"><a class="btn default blue" onclick="myFunction('NA');">Add New<i class="fa fa-plus"></i> </a>
											</div>
                    					</div>
										<div class="col-md-6">
...
BU.init('bussmast','buss','sample_2','1','Business Unit');
	 function myFunction(bussCode){
		 $.ajax({url: "content/edit/edit_bussiness_unit.php?BUSSID="+bussCode,
			 cache: false,
			 beforeSend: function(){
				 loading();
			 },
