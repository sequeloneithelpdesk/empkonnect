...
?>
<?php $c_val["Admin"]["Organization Structures"]["Qualification"] = 'end1234'; ?>
<!DOCTYPE html>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Qualification List
								</div>
								<div class="tools">
...
BU.init('QualMast','Qual','sample_2','1','Qualification');

function myFunction(oid){
		$.ajax({url: "content/edit/edit_qualification.php?pagetype=editQualification&oqualCode="+oid, success: function(result){
			console.log(result);
			$('#edit').show();
			$('#edit').html(result);
			$('#large1').modal('show');
