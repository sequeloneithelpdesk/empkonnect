...
?>
<?php $c_val["Admin"]["Organization Structures"]["University"] = 'end1234'; ?>
<!DOCTYPE html>
<!-- 
					...
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
								...
								<h4 class="modal-title"><div class="caption"><b>Edit University Details</b></div></h4>
							</div>
        ...
        <div class="modal fade bs-modal-lg" id="large" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog lg">
						<div class="modal-content" style="width:850px;">
							<div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                                            <h4 class="modal-title"><div class="caption"><b>Add New University</b></div></h4>
							</div>
							<div class="modal-body">                
                <?php include ("content/add/add_university.php");?>
                </div>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View University List
								</div>
								<div class="tools">
...
<script src="js/add/add_university_validation.js"></script>
<script src="js/edit/edit_university_validation.js"></script>
...
BU.init('UnivMast','Univ','sample_2','1','University');
</script>
</body>
<!-- END BODY -->
</html>
