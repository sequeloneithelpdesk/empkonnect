...
?>
<?php $c_val["Admin"]["Organization Structures"]["Country"] = 'end1234'; ?>
<!DOCTYPE html>
<html lang="en">
<!--<![endif]-->
<!-- BEGIN HEAD -->
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Country List
								</div>
								<div class="tools">
...
BU.init('CountryMast','Country','sample_2','1','Country');
function myFunction(oid){
  $.ajax({url: "content/edit/edit_country.php?pagetype=editCountry&countryId="+oid,
			cache: false,
			 beforeSend: function(){
				 loading();
			 },
