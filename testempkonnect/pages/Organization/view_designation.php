...
$c_val["Admin"]["Organization Structures"]["Designation"] = 'end1234'; 
?>
<!DOCTYPE html>
<html lang="en">
<head>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Designation List
								</div>
								<div class="tools">
...
BU.init('DsgMast','Dsg','sample_2','1','Designation');
function myFunction(oid){
		$.ajax({url: "content/edit/edit_designation.php?oid="+oid,
			cache: false,
			 beforeSend: function(){
				 loading();
			 },
