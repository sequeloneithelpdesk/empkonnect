...
$c_val["Admin"]["Organization Structures"]["Division"] = 'end1234'; 
?>
<!DOCTYPE html>
<html lang="en">
<head>
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Division List
								</div>
								<div class="tools">
...
BU.init('DiviMast','Divi','sample_2','1','Division');
function myFunction(oid){
		$.ajax({url: "content/edit/edit_division.php?oid="+oid, 
		cache: false,
			 beforeSend: function(){
				 loading();
			 },
