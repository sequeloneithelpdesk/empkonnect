...
include ('../configdata.php');
    ...
    $c_val["Admin"]["Organization Structures"]["Work Locations"] = 'end1234'; 
?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<!-- /.modal -->
				 ...
				 <div class="modal fade bs-modal-lg" id="large1" tabindex="-1" role="dialog" aria-hidden="true">
					<div class="modal-dialog lg">
						<div id="edit" class="modal-content" style="width:850px;">
					...
					<div class="col-md-12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption">
									<i class="fa fa-globe"></i>View Work Location List
								</div>
								<div class="tools">
...
BU.init('WorkLocMast','WLoc','sample_2','1','Work Location');

	function myFunction(wlid){
		$.ajax({url: "content/edit/edit_work_location.php?pagetype=editWorkLocation&wlid="+wlid,
		cache: false,
			 beforeSend: function(){
				 loading();
			 },
