...
if((!isset($_SESSION['usercode']) || $_SESSION['usercode']=="")&& (!isset($_SESSION['usertype']) || $_SESSION['usertype']=="")){
    ...
    $c_val["Admin"]["Organization Structures"]["Functions"] = 'end1234'; 
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<script src="js/common_bu.js" type="text/javascript"></script>
...
BU.init('FUNCTMast','FUNCT','sample_2','1','Function');

	function myFunction(wlid){
		$.ajax({url: "content/edit/edit_function.php?pagetype=edit_function&Id="+wlid, success: function(result){
			console.log(result);
			$('#edit').show();
			$('#edit').html(result);
			$('#large1').modal('show');
