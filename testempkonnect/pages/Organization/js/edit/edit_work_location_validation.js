var FormValidation = function () {
    ...
    var handleValidation1 = function() {
            ...
            form1.validate({
                ...
                submitHandler: 
                function (form) {                  
                      //var url = "ajax/edit/edit_work_location_ajax.php";
                      var url = "ajax/editData.php?pagetype=edit_work_location";
...
$.ajax({url: "content/edit/edit_work_location.php?pagetype=editWorkLocation&wlid="+wlid, success: function(result){
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
		FormValidation.init();
