var FormValidation = function () {
  ...
  var handleValidation1 = function() {
            ...
            form1.validate({
                ...
                function (form) {                  
                          var url = "ajax/editData.php?pagetype=edit_function";
...
function myFunction(id){
  $.ajax({url: "content/edit/edit_function.php?pagetype=editFunction&id="+id, success: function(result){
  //alert (univCode);
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
...
function viewTable(){
  $.ajax({url: "viewTables.php?pagetype=viewFunction", success: function(result){
  console.log(result);
        $('#view').html(result);  
        return false;
    }});
