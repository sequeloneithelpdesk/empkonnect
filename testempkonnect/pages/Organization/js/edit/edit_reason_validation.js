    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                function (form) {                  
                      var url = "editData.php?pagetype=edit_reason";
...
function myFunction(rcode){
$.ajax({url: "content/edit/edit_reason.php?pagetype=editReason&rcode="+rcode, success: function(result){
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
		FormValidation.init();
