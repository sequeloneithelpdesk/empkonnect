    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                function (form) {                  
                      var url = "ajax/editData.php?pagetype=edit_process";
...
function myFunction(PROCID){
  //alert (univCode);
$.ajax({url: "content/edit/edit_process.php?pagetype=editProcess&PROCID="+PROCID, success: function(result){
  //alert (cityId);
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
