    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                function (form) {                  
                      var url = "ajax/editData.php?pagetype=edit_state";
...
function myFunction(ostateId){
   
     $.ajax({url: "content/edit/edit_state.php?pagetype=editState&ostateId="+ostateId, success: function(result){
                console.log(result);
                $('#edit').show();
                $('#edit').html(result);
		FormValidation.init();
