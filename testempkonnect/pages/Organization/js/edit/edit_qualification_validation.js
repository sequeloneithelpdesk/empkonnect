    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                function (form) {                  
                      var url = "editData.php?pagetype=edit_qualification";
...
function myFunction(oqualCode){
  //alert (univCode);
$.ajax({url: "content/edit/edit_qualification.php?pagetype=editQualification&oqualCode="+oqualCode, success: function(result){
  //alert (cityId);
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
