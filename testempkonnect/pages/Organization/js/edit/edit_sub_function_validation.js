    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                function (form) {                  
                      var url = "ajax/editData.php?pagetype=edit_sub_function";
...
$.ajax({url: "content/edit/edit_sub_function.php?pagetype=edit_sub_function&id="+id, success: function(result){
  console.log(result);
  $('#edit').show();
        $('#edit').html(result);
		FormValidation.init();
