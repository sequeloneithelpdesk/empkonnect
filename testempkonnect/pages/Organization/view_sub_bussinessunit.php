...
$c_val["Admin"]["Organization Structures"]["Sub Business Unit"] = 'end1234';
?>
<!DOCTYPE html>
<html lang="en">
    <head>
	...
	<!-- END PAGE LEVEL STYLES -->
        ...
        <link href="../../assets/admin/layout2/css/layout.css" type="text/css" rel="stylesheet" />
        <link href="../../assets/admin/layout2/css/themes/grey.css" id="style_color" rel="stylesheet" type="text/css"/>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="portlet box blue">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <i class="fa fa-globe"></i>View Sub Bussiness Unit List
                                        </div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                                            <thead>
                                                <tr class='odd gradeX'>
                                                    <th>Sub Business Unit Name</th>
												<th>Sub Business Unit Code</th>
...
<script src="js/common_bu.js"></script>
        <script>
			...
			BU.init('subBussMast','subBuss','sample_2','1','Sub Business Unit');
			function myFunction(oid){
		$.ajax({url: "content/edit/edit_subbussiness_unit.php?subBussID="+oid, success: function(result){
			console.log(result);
			$('#edit').show();
			$('#edit').html(result);
			$('#large1').modal('show');
