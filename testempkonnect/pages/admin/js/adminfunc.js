...
var polform = {
  ...
  policies : function(){
      ...
      if(name==""|| aFormData.length=="undefined"){
          toasterrormsg("Fill All valid Fields. ");
      }
      else {
          $.ajax({
              type: "POST",
              url: "ajax/policies.php?type=policies&name=" + name,
              data: aFormData,
              cache: false,
              processData: false,
              contentType: false,
...
$("#submitpasspolicy").click(function() {
    ...
    var change_password_days,change_password_days_status,earlier_password_use,earlier_password_use_status,userid_case_sensitive,
        ...
        password_reset_link_status,password_reset_ques1,password_reset_ques1_status,ask_for_otp,ask_for_otp_status;
            ...
            success: function (result) {
                    if(result == 1) {
                        ...
                        setInterval(function() {
                           window.location.href='passwordPolicy.php';
                        }, 3);
                    }else if(result == 2) {
