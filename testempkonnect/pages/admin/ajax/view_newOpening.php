...
if(sqlsrv_num_rows($resultq)) {
    ...
    while ($rowq = sqlsrv_fetch_array($resultq)) {
        ?>
        <form enctype="multipart/form-data" id="form5" name="viewnewOpening"
              class="form-horizontal form-row-seperated">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true" id="close"></button>
            <h4 class="modal-title"><b>View Vacancy</b> </h4>
        </div>
        <div class="modal-body">
            <div class="row">
                <div class="col-md-6">
                    <label class="control-label col-md-3"><?php echo $rowq['Title'];?></label>
                </div>
                <div class="col-md-6">
