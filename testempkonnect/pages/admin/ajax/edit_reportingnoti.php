        ...
        <form enctype="multipart/form-data" id="form5" name="editdeptnotify"
                        ...
                        <div id="checkboxes" style="overflow-y: scroll;width: 20em;height:20em">
                            ...
                            if($num($resultq1)) {
                                ...
                                while ($rowq1 = $fetch($resultq1)) {
                                    ?>
                                    <label for="<?php echo $rowq1['Emp_Code'];?>"><input type="checkbox" id="<?php echo $rowq1['Emp_Code'];?>" class="empcheck" name="team[]" value="<?php echo $rowq1['Emp_Code'];?>" <?php echo (in_array($rowq1['Emp_Code'],$team_mem) ? 'checked' : '');?>/><?php echo $rowq1['EMP_NAME'];?></label>
            ...
            <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <textarea name="content" data-provide="markdown" name="editor2" id="reporteditor"rows="6"><?php echo $rowq['notification'];?></textarea>
            ...
            <div class="modal-footer">
                <button type="button" class="btn green" id="RUnotification" onclick="update_report();" value="edit"><i class="fa fa-check"></i>Submit
                </button>
            </div>
