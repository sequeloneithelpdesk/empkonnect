...
//$c_val["Time Management"]["View Roster"] = 'end1234';
$c_val = 'end1234';
?>
...
<div class="clearfix">
		...
		<div class="page-content-wrapper">
			<div class="page-content cus-light-grey">
				...
				// $to=array("himanshu@agnitioworld.com")  ; 
				// //print_r($to);
				...
				<!-- END PAGE HEADER-->
				<!-- BEGIN PAGE CONTENT-->
				<?php include('content/viewroster_content.php'); ?>
...
<script src="js/view_roster.js"></script>
