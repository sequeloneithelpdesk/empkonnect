...
$c_val["Time Management"]["My Past Attendance Request"] = 'end1234';
?>
<!DOCTYPE html>
...
<div class="page-content-wrapper cus-dark-grey">
    ...
    <div class="page-container">
        ...
        <!-- END SIDEBAR -->
        <!-- BEGIN CONTENT -->
        <?php include ('content/myPastAttenRequest_content.php');?>
...
<script>
    ...
    function getmypastId(myodId,status,code){
        ...
        $.ajax({
            type: "POST",
            url: "content/view_mypastAttendancePopup.php",
            data: {id: myodId, status:status, code:code},
            success: function (result) {
                 $('#mypastrequest').html(result);
            }
        });
    }


    function submitCancelRequest(pastid,createdBy,status,pastkey){
        ...
        if(remark == ""){
            ...
            $.ajax({
                type: "POST",
                url: "ajax/markPastAtten_ajax.php",
                data: {id: pastid, type:type,status:status,pastkey:pastkey,user:createdBy,remark:remark},
                success: function (result) {
                    if(result == 1){
                        location.reload();
                     }else{
